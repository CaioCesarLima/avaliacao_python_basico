Você deverá desenvolver, em Python, um sistema simples de controle de vendas em uma loja fictícia, utilizando variáveis, estruturas condicionais (if/else), laços de repetição (for e while) e funções.
